...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter{
    ...
    private void sendWeatherInfoToWearable()
    {
        ...
        if (cursor.moveToFirst()) {
            ...
            double minimumTemp = cursor.getDouble(INDEX_MIN_TEMP);
            double maxmimumTemp = cursor.getDouble(INDEX_MAX_TEMP);

            String high = Utility.formatTemperature(context, maxmimumTemp);
            String low = Utility.formatTemperature(context, minimumTemp);
            ...
            weatherDataMap.putString(HIGH_TEMPERATURE, high);
            weatherDataMap.putString(LOW_TEMPERATURE, low);
            weatherDataMap.putInt(WEATHER_ID, weatherId);
            weatherDataMap.putLong("Time", System.currentTimeMillis());
